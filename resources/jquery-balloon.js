...
;(function($) {
	...
	function makeupBalloon($target, $balloon, options) {
		...
		if(options.tipSize > 0) {
			...
			outerTip = new NumericalBoxElement($("<div>").css(initTipStyle).addClass('outerTip').appendTo($balloon));
			innerTip = new NumericalBoxElement($("<div>").css(initTipStyle).addClass('innerTip').appendTo($balloon));
